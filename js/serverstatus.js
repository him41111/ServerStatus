...
function uptime() {
    $.getJSON("https://s.him411.top/json/stats.json", function(result) {
      
      var shstr = '<div class="col-lg-4 col-md-4 col-sm-4">'+
                       ' <div class="panel panel-block panel-block-sm panel-location">'+
                            '<div class="location-header">'+

                               ' <h3 class="h4"><img src="https://cdn.jsdelivr.net/gh/him41111/ServerStatus-Hotaru/web/img/clients/webp/@region.webp"> @name <small>@type</small></h3>'+
